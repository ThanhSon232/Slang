 ...
 * @author tranthanhson
 */
public class DeleteSlangGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete a Slang");
...
//        jTextPane2.setText((String)randomValue);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteSlangGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteSlangGUI().setVisible(true);
            }
        });
    }
